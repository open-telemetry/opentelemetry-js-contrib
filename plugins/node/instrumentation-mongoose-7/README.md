...
```bash
npm install --save @opentelemetry/instrumentation-mongoose-7
```

## Supported Versions

- `>=7.0.5 <8`
For versions <7, please use `@opentelemetry/instrumentation-mongoose`
...
const { MongooseInstrumentation } = require('@opentelemetry/instrumentation-mongoose-7');
