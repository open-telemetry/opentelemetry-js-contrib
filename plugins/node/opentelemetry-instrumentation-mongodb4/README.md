# OpenTelemetry mongodb4 Instrumentation for Node.js
...
This module provides automatic instrumentation for [`mongodb4`](https://github.com/mongodb/node-mongodb-native).
