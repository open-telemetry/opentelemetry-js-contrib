// This file is copied from https://www.npmjs.com/package/@types/mongodb/v/3.6.20
// The original types package had dependency on "@types/bson": "*" which pulls the
// latest version. @types/bson@5.0.0 had a breaking change which is not compatible
// with v3 and broke our build.
// by copying the file we can avoid the dependency on @types/bson and set it the a specific (correct) version.
// another alternatives which didn't work:
//
// - using npm "overrides" key - not supported by npm6 which we use with node14
//   https://docs.npmjs.com/cli/v9/configuring-npm/package-json#overrides
//
// - fixing the original issue in definatly typed repo - the types package is deprecated and removed from codebase
//
// - publishing our own "fixed" version of @types/mongodb - didn't work with typescript 
