...
:bangbang: You could be a component owner for this package, and help maintain the quality its users deserve! Check out [open issues](https://github.com/open-telemetry/opentelemetry-js-contrib/labels/pkg%3Ainstrumentation-graphql-tools-executor) on how to help.
...
```shell script
npm install @opentelemetry/instrumentation-graphql-tools-executor
```
...
const { GraphQLToolsExecutorInstrumentation } = require('@opentelemetry/instrumentation-graphql-tools-executor');
...
registerInstrumentations({
  instrumentations: [
    new GraphQLToolsExecutorInstrumentation({
      // optional params
      // allowValues: true,
      // depth: 2,
      // mergeItems: true,
