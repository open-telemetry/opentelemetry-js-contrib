...
const dockerRunCmds = {
  ...
  mysql:
    'docker run --rm -d --name otel-mysql -p 33306:3306 -e MYSQL_ROOT_PASSWORD=rootpw -e MYSQL_DATABASE=test_db -e MYSQL_USER=otel -e MYSQL_PASSWORD=secret mysql:8.0 --log_output=TABLE --general_log=ON --default-authentication-plugin=mysql_native_password',
  postgres:
