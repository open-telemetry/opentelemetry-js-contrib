...
## [0.80.1](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/auto-instrumentations-node-v0.80.0...auto-instrumentations-node-v0.80.1) (2026-09-04)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-winston bumped from ^0.65.0 to ^0.66.0
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.36.0 to ^0.37.0
    * @opentelemetry/resource-detector-aws bumped from ^2.21.0 to ^2.22.0
    * @opentelemetry/resource-detector-azure bumped from ^0.29.0 to ^0.30.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.12 to ^0.8.13
    * @opentelemetry/resource-detector-gcp bumped from ^0.56.0 to ^0.57.0
...
* **auto-instrumentations-node:** avoid duplicate diag logger warning in register.js ([#3601](https://github.com/open-telemetry/opentelemetry-js-contrib/issues/3601)) ([3ae8a1b](https://github.com/open-telemetry/opentelemetry-js-contrib/commit/3ae8a1be43ba7cd0c5e2a5955bafb65e78df6312))
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-router bumped from ^0.64.0 to ^0.65.0
    * @opentelemetry/instrumentation-runtime-node bumped from ^0.33.0 to ^0.34.0
    * @opentelemetry/instrumentation-socket.io bumped from ^0.67.0 to ^0.68.0
    * @opentelemetry/instrumentation-tedious bumped from ^0.39.0 to ^0.40.0
    * @opentelemetry/instrumentation-undici bumped from ^0.30.0 to ^0.31.0
    * @opentelemetry/instrumentation-winston bumped from ^0.64.0 to ^0.65.0
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.35.0 to ^0.36.0
    * @opentelemetry/resource-detector-aws bumped from ^2.20.0 to ^2.21.0
    * @opentelemetry/resource-detector-azure bumped from ^0.28.0 to ^0.29.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.11 to ^0.8.12
    * @opentelemetry/resource-detector-gcp bumped from ^0.55.0 to ^0.56.0

## [0.78.0](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/auto-instrumentations-node-v0.77.0...auto-instrumentations-node-v0.78.0) (2026-07-03)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-winston bumped from ^0.63.0 to ^0.64.0
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.34.0 to ^0.35.0
    * @opentelemetry/resource-detector-aws bumped from ^2.19.0 to ^2.20.0
    * @opentelemetry/resource-detector-azure bumped from ^0.27.0 to ^0.28.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.10 to ^0.8.11
    * @opentelemetry/resource-detector-gcp bumped from ^0.54.0 to ^0.55.0
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-undici bumped from ^0.28.0 to ^0.29.0
    * @opentelemetry/instrumentation-winston bumped from ^0.62.0 to ^0.63.0
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.33.8 to ^0.34.0
    * @opentelemetry/resource-detector-aws bumped from ^2.18.0 to ^2.19.0
    * @opentelemetry/resource-detector-azure bumped from ^0.26.0 to ^0.27.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.9 to ^0.8.10
    * @opentelemetry/resource-detector-gcp bumped from ^0.53.0 to ^0.54.0

## [0.76.0](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/auto-instrumentations-node-v0.75.0...auto-instrumentations-node-v0.76.0) (2026-05-13)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.33.7 to ^0.33.8
    * @opentelemetry/resource-detector-aws bumped from ^2.17.0 to ^2.18.0
    * @opentelemetry/resource-detector-azure bumped from ^0.25.0 to ^0.26.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.8 to ^0.8.9
    * @opentelemetry/resource-detector-gcp bumped from ^0.52.0 to ^0.53.0

## [0.75.0](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/auto-instrumentations-node-v0.74.0...auto-instrumentations-node-v0.75.0) (2026-05-06)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.33.6 to ^0.33.7
    * @opentelemetry/resource-detector-aws bumped from ^2.16.0 to ^2.17.0
    * @opentelemetry/resource-detector-azure bumped from ^0.24.0 to ^0.25.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.7 to ^0.8.8
    * @opentelemetry/resource-detector-gcp bumped from ^0.51.0 to ^0.52.0

## [0.74.0](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/auto-instrumentations-node-v0.73.0...auto-instrumentations-node-v0.74.0) (2026-04-29)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.33.5 to ^0.33.6
    * @opentelemetry/resource-detector-aws bumped from ^2.15.0 to ^2.16.0
    * @opentelemetry/resource-detector-azure bumped from ^0.23.0 to ^0.24.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.6 to ^0.8.7
    * @opentelemetry/resource-detector-gcp bumped from ^0.50.0 to ^0.51.0

## [0.73.0](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/auto-instrumentations-node-v0.72.0...auto-instrumentations-node-v0.73.0) (2026-04-17)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.33.4 to ^0.33.5
    * @opentelemetry/resource-detector-aws bumped from ^2.14.0 to ^2.15.0
    * @opentelemetry/resource-detector-azure bumped from ^0.22.0 to ^0.23.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.5 to ^0.8.6
    * @opentelemetry/resource-detector-gcp bumped from ^0.49.0 to ^0.50.0

## [0.72.0](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/auto-instrumentations-node-v0.71.0...auto-instrumentations-node-v0.72.0) (2026-03-25)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-runtime-node bumped from ^0.26.0 to ^0.27.0
    * @opentelemetry/instrumentation-socket.io bumped from ^0.60.0 to ^0.61.0
    * @opentelemetry/instrumentation-tedious bumped from ^0.32.0 to ^0.33.0
    * @opentelemetry/instrumentation-undici bumped from ^0.23.0 to ^0.24.0
    * @opentelemetry/instrumentation-winston bumped from ^0.57.0 to ^0.58.0
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.33.3 to ^0.33.4
    * @opentelemetry/resource-detector-aws bumped from ^2.13.0 to ^2.14.0
    * @opentelemetry/resource-detector-azure bumped from ^0.21.0 to ^0.22.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.4 to ^0.8.5
    * @opentelemetry/resource-detector-gcp bumped from ^0.48.0 to ^0.49.0
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-winston bumped from ^0.56.0 to ^0.57.0
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.33.2 to ^0.33.3
    * @opentelemetry/resource-detector-aws bumped from ^2.12.0 to ^2.13.0
    * @opentelemetry/resource-detector-azure bumped from ^0.20.0 to ^0.21.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.3 to ^0.8.4
    * @opentelemetry/resource-detector-gcp bumped from ^0.47.0 to ^0.48.0
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-router bumped from ^0.55.0 to ^0.56.0
    * @opentelemetry/instrumentation-runtime-node bumped from ^0.24.0 to ^0.25.0
    * @opentelemetry/instrumentation-socket.io bumped from ^0.57.0 to ^0.58.0
    * @opentelemetry/instrumentation-tedious bumped from ^0.30.0 to ^0.31.0
    * @opentelemetry/instrumentation-undici bumped from ^0.21.0 to ^0.22.0
    * @opentelemetry/instrumentation-winston bumped from ^0.55.0 to ^0.56.0
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.33.1 to ^0.33.2
    * @opentelemetry/resource-detector-aws bumped from ^2.11.0 to ^2.12.0
    * @opentelemetry/resource-detector-azure bumped from ^0.19.0 to ^0.20.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.2 to ^0.8.3
    * @opentelemetry/resource-detector-gcp bumped from ^0.46.0 to ^0.47.0
...
* The following workspace dependencies were updated
  * dependencies
    * @opentelemetry/instrumentation-amqplib bumped from ^0.57.0 to ^0.58.0
    * @opentelemetry/instrumentation-aws-lambda bumped from ^0.62.0 to ^0.63.0
    * @opentelemetry/instrumentation-aws-sdk bumped from ^0.65.0 to ^0.66.0
    * @opentelemetry/instrumentation-bunyan bumped from ^0.55.0 to ^0.56.0
    * @opentelemetry/instrumentation-cassandra-driver bumped from ^0.55.0 to ^0.56.0
    * @opentelemetry/instrumentation-connect bumped from ^0.53.0 to ^0.54.0
    * @opentelemetry/instrumentation-cucumber bumped from ^0.25.0 to ^0.26.0
    * @opentelemetry/instrumentation-dataloader bumped from ^0.27.0 to ^0.28.0
    * @opentelemetry/instrumentation-dns bumped from ^0.53.0 to ^0.54.0
    * @opentelemetry/instrumentation-express bumped from ^0.58.0 to ^0.59.0
    * @opentelemetry/instrumentation-fastify bumped from ^0.54.0 to ^0.55.0
    * @opentelemetry/instrumentation-fs bumped from ^0.29.0 to ^0.30.0
    * @opentelemetry/instrumentation-generic-pool bumped from ^0.53.0 to ^0.54.0
    * @opentelemetry/instrumentation-graphql bumped from ^0.57.0 to ^0.58.0
    * @opentelemetry/instrumentation-hapi bumped from ^0.56.0 to ^0.57.0
    * @opentelemetry/instrumentation-ioredis bumped from ^0.58.0 to ^0.59.0
    * @opentelemetry/instrumentation-kafkajs bumped from ^0.19.0 to ^0.20.0
    * @opentelemetry/instrumentation-knex bumped from ^0.54.0 to ^0.55.0
    * @opentelemetry/instrumentation-koa bumped from ^0.58.0 to ^0.59.0
    * @opentelemetry/instrumentation-lru-memoizer bumped from ^0.54.0 to ^0.55.0
    * @opentelemetry/instrumentation-memcached bumped from ^0.53.0 to ^0.54.0
    * @opentelemetry/instrumentation-mongodb bumped from ^0.63.0 to ^0.64.0
    * @opentelemetry/instrumentation-mongoose bumped from ^0.56.0 to ^0.57.0
    * @opentelemetry/instrumentation-mysql bumped from ^0.56.0 to ^0.57.0
    * @opentelemetry/instrumentation-mysql2 bumped from ^0.56.0 to ^0.57.0
    * @opentelemetry/instrumentation-nestjs-core bumped from ^0.56.0 to ^0.57.0
    * @opentelemetry/instrumentation-net bumped from ^0.54.0 to ^0.55.0
    * @opentelemetry/instrumentation-openai bumped from ^0.8.0 to ^0.9.0
    * @opentelemetry/instrumentation-oracledb bumped from ^0.35.0 to ^0.36.0
    * @opentelemetry/instrumentation-pg bumped from ^0.62.0 to ^0.63.0
    * @opentelemetry/instrumentation-pino bumped from ^0.56.0 to ^0.57.0
    * @opentelemetry/instrumentation-redis bumped from ^0.58.0 to ^0.59.0
    * @opentelemetry/instrumentation-restify bumped from ^0.55.0 to ^0.56.0
    * @opentelemetry/instrumentation-router bumped from ^0.54.0 to ^0.55.0
    * @opentelemetry/instrumentation-runtime-node bumped from ^0.23.0 to ^0.24.0
    * @opentelemetry/instrumentation-socket.io bumped from ^0.56.0 to ^0.57.0
    * @opentelemetry/instrumentation-tedious bumped from ^0.29.0 to ^0.30.0
    * @opentelemetry/instrumentation-undici bumped from ^0.20.0 to ^0.21.0
    * @opentelemetry/instrumentation-winston bumped from ^0.54.0 to ^0.55.0
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.33.0 to ^0.33.1
    * @opentelemetry/resource-detector-aws bumped from ^2.10.0 to ^2.11.0
    * @opentelemetry/resource-detector-azure bumped from ^0.18.0 to ^0.19.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.1 to ^0.8.2
    * @opentelemetry/resource-detector-gcp bumped from ^0.45.0 to ^0.46.0

## [0.68.0](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/auto-instrumentations-node-v0.67.3...auto-instrumentations-node-v0.68.0) (2026-01-14)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-undici bumped from ^0.19.0 to ^0.20.0
    * @opentelemetry/instrumentation-winston bumped from ^0.53.0 to ^0.54.0
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.32.0 to ^0.33.0
    * @opentelemetry/resource-detector-aws bumped from ^2.9.0 to ^2.10.0
    * @opentelemetry/resource-detector-azure bumped from ^0.17.0 to ^0.18.0
    * @opentelemetry/resource-detector-container bumped from ^0.8.0 to ^0.8.1
    * @opentelemetry/resource-detector-gcp bumped from ^0.44.0 to ^0.45.0
...
* The following workspace dependencies were updated
  * dependencies
    * @opentelemetry/instrumentation-amqplib bumped from ^0.55.0 to ^0.56.0
    * @opentelemetry/instrumentation-aws-lambda bumped from ^0.61.0 to ^0.61.1
    * @opentelemetry/instrumentation-aws-sdk bumped from ^0.64.0 to ^0.64.1
    * @opentelemetry/instrumentation-cassandra-driver bumped from ^0.54.0 to ^0.54.1
    * @opentelemetry/instrumentation-dataloader bumped from ^0.26.0 to ^0.26.1
    * @opentelemetry/instrumentation-express bumped from ^0.57.0 to ^0.57.1
    * @opentelemetry/instrumentation-fastify bumped from ^0.53.0 to ^0.53.1
    * @opentelemetry/instrumentation-hapi bumped from ^0.55.0 to ^0.55.1
    * @opentelemetry/instrumentation-ioredis bumped from ^0.56.0 to ^0.57.0
    * @opentelemetry/instrumentation-kafkajs bumped from ^0.18.0 to ^0.18.1
    * @opentelemetry/instrumentation-koa bumped from ^0.57.0 to ^0.57.1
    * @opentelemetry/instrumentation-lru-memoizer bumped from ^0.53.0 to ^0.53.1
    * @opentelemetry/instrumentation-memcached bumped from ^0.52.0 to ^0.52.1
    * @opentelemetry/instrumentation-mongodb bumped from ^0.61.0 to ^0.62.0
    * @opentelemetry/instrumentation-mongoose bumped from ^0.55.0 to ^0.55.1
    * @opentelemetry/instrumentation-mysql bumped from ^0.54.0 to ^0.55.0
    * @opentelemetry/instrumentation-mysql2 bumped from ^0.55.0 to ^0.55.1
    * @opentelemetry/instrumentation-net bumped from ^0.52.0 to ^0.53.0
    * @opentelemetry/instrumentation-openai bumped from ^0.7.0 to ^0.7.1
    * @opentelemetry/instrumentation-oracledb bumped from ^0.34.0 to ^0.34.1
    * @opentelemetry/instrumentation-pg bumped from ^0.61.1 to ^0.61.2
    * @opentelemetry/instrumentation-pino bumped from ^0.55.0 to ^0.55.1
    * @opentelemetry/instrumentation-redis bumped from ^0.57.1 to ^0.57.2
    * @opentelemetry/instrumentation-socket.io bumped from ^0.55.0 to ^0.55.1
    * @opentelemetry/instrumentation-tedious bumped from ^0.27.0 to ^0.28.0
    * @opentelemetry/resource-detector-alibaba-cloud bumped from ^0.31.11 to ^0.32.0
    * @opentelemetry/resource-detector-aws bumped from ^2.8.0 to ^2.9.0
    * @opentelemetry/resource-detector-azure bumped from ^0.16.0 to ^0.17.0
    * @opentelemetry/resource-detector-container bumped from ^0.7.11 to ^0.8.0
    * @opentelemetry/resource-detector-gcp bumped from ^0.43.0 to ^0.44.0
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-net bumped from ^0.49.0 to ^0.49.1
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-undici bumped from ^0.15.0 to ^0.16.0
...
## [0.58.1](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/auto-instrumentations-node-v0.58.0...auto-instrumentations-node-v0.58.1) (2025-05-02)
