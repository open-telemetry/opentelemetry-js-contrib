...
| Resource Attribute        | Description                                                                                                                                                                                                                                                                                        |
|---------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| azure.resource_group.name | The Azure resource group containing the Azure Function. Value of Process Environment Variable `WEBSITE_RESOURCE_GROUP`.                                                                                                                                                                            |
| cloud.account.id          | The Azure subscription ID containing the Azure Function. Parsed from Process Environment Variable `WEBSITE_OWNER_NAME`.                                                                                                                                                                            |
