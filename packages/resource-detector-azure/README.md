...
| azure.resource_group.name   | The Azure resource group containing the App Service. Value of Process Environment Variable `WEBSITE_RESOURCE_GROUP`.                                                                                       |
| cloud.account.id            | The Azure subscription ID containing the App Service. Parsed from Process Environment Variable `WEBSITE_OWNER_NAME`.                                                                                       |
