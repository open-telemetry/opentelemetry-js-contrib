...
const CONTAINER_APP_ATTRIBUTE_ENV_VARS = {
  [ATTR_CONTAINER_NAME]: CONTAINER_APP_NAME,
  [ATTR_HOST_ID]: CONTAINER_APP_HOSTNAME,
  [ATTR_SERVICE_INSTANCE_ID]: CONTAINER_APP_REPLICA_NAME,
  [AZURE_CONTAINER_APPS_REVISION]: CONTAINER_APP_REVISION,
}
  ...
  detect(): DetectedResource {
    ...
    if (isAzureContainerApps()) {
      attributes = {
        ...
        [ATTR_HOST_NAME]: `${process.env[CONTAINER_APP_NAME]}.${process.env[CONTAINER_APP_ENV_DNS_SUFFIX]}`,
      };
