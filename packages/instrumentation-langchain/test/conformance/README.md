...
No delegated inference, retrieval, prompt, or metric expectations are declared.
...
reasons, with content capture independently off and on. No expected violations
are suppressed; missing tools, missing spans or convention violations fail.
