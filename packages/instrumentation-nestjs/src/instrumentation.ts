...
export function createWrapNestFactoryCreateMicroservice(
  tracer: api.Tracer,
  moduleVersion?: string
) {
...
export function createWrapConnectMicroservice(
  tracer: api.Tracer,
  moduleVersion?: string
) {
...
export function createWrapRegisterPatternHandlers(
  tracer: api.Tracer,
  moduleVersion?: string
) {
...
export function createWrapRpcContextCreator(
  tracer: api.Tracer,
  moduleVersion?: string
) {
