...
const ALIYUN_HOST =
  'http://' + alibabaCloudEcsDetectorSync.ALIBABA_CLOUD_IDMS_ENDPOINT;
const ALIYUN_IDENTITY_PATH =
  alibabaCloudEcsDetectorSync.ALIBABA_CLOUD_INSTANCE_IDENTITY_DOCUMENT_PATH;
const ALIYUN_HOST_PATH =
  alibabaCloudEcsDetectorSync.ALIBABA_CLOUD_INSTANCE_HOST_DOCUMENT_PATH;
