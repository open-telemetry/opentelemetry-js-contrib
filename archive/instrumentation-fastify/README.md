...
>
> The last published version of `@opentelemetry/instrumentation-fastify` was version v0.56.0 (29 Jan 2026).
> For reference, the [source code for the last version can be found here][last-code].

[last-code]: https://github.com/open-telemetry/opentelemetry-js-contrib/tree/instrumentation-fastify-v0.56.0/packages/instrumentation-fastify/
